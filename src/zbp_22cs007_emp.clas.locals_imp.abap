...
CLASS lhc_EMP IMPLEMENTATION.
 ...
 DATA ls_employee TYPE Z22CS007_EMP.
 ...
 ENDMETHOD.
ENDCLASS.
CLASS lsc_Z22CS007_I_EMP DEFINITION
...
ENDCLASS.
CLASS lsc_Z22CS007_I_EMP IMPLEMENTATION.
 METHOD finalize.
 ENDMETHOD.
 ...
 CASE <ls_buf>-flag.
 WHEN 'C'.
 INSERT Z22CS007_EMP FROM @<ls_buf>-lv_data.
 WHEN 'U'.
 UPDATE Z22CS007_EMP FROM @<ls_buf>-lv_data.
 WHEN 'D'.
 DELETE FROM Z22CS007_EMP
